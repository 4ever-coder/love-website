...
[打开七夕情侣纪念网页在线预览](https://4ever-coder.github.io/love-website/)
...
本项目采用《个人非商业使用许可协议》（Personal Use and Non-Commercial License），详见 [`LICENSE`](LICENSE)。本项目不是 MIT、Apache 等标准开源许可证授权项目。

## 使用权限

本项目当前仅限个人学习、展示和非商业使用。未经版权所有者书面许可，禁止将本项目或其衍生作品用于商业项目、收费服务、商业宣传、售卖、转授权或其他营利活动；禁止私自商用。

如需商业授权，请在使用前联系版权所有者并取得书面许可。项目中的第三方素材可能有独立授权要求，使用时请遵守对应条款。
